...
class Robot_player(Robot):
    ...
    trial = 0
    trial_score = 0
    trial_repeat = 0  # pour évaluer chaque stratégie 3 fois
    ...
    def __init__(self, x_0, y_0, theta_0, name="n/a", team="n/a", evaluations=500, it_per_evaluation=400):
        ...
        # Vider le fichier à la toute première exécution
        if self.robot_id == 0:
    ...
    def step(self, sensors, sensor_view=None, sensor_robot=None, sensor_team=None):
            ...
            if self.iteration % self.it_per_evaluation == 0:
                if self.iteration > 0:
                    ...
                    if self.trial_repeat < 3:
                        ...
                        if self.trial_score > self.best_score:
                            self.best_score = self.trial_score
        ...
        # Rejouer la meilleure stratégie toutes les 1000 itérations
